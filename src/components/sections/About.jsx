...
export default function About({ onParticleBurst }) {
  ...
  const effectiveActiveCard =
    clickOverrideCardId ?? hoverCardId ?? scrollActiveCard;
      ...
      <div className="mx-auto flex max-w-4xl flex-col gap-10 lg:max-w-5xl">
        ...
        <div className="flex flex-col gap-3 text-left">
          ...
          <p className="font-display text-lg text-mist sm:text-xl">
            Raw telemetry, academic weights, and engineering mission streaming
            into the pipeline.
          </p>
        </div>
        ...
        <div ref={gridRef} className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          >
            ...
            <p className="font-display text-base leading-relaxed text-foam/90">
              Most of what I build starts with a dataset or a repetitive task I
              want gone. My engineering work bridges full-stack software and
              machine learning.
            </p>

            <div className="text-sm leading-relaxed text-mist flex flex-col gap-3">
              <p>
                I like building things that solve real, tedious problems, not
                just demo well. My main project, FormAnchor, is a Chrome
                extension that automates bulk form-filling from Excel data for
                government and banking workflows, built on a resilient
                multi-engine architecture.
              </p>
              <p>
                I also work with Python and data — including exploratory
                analysis on Shark Tank India and Netflix datasets and an
                MCP-based Expense Tracker server. Currently looking for
                internships where I can keep building things people
              </p>
            </div>
          ...
          >
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="flex flex-col gap-1 rounded-lg border border-hairline/60 bg-void/50 p-3.5">
                ...
                <span className="font-display font-medium text-foam">
                  {IDENTITY.education}
                </span>
              </div>
              ...
              <div className="flex flex-col gap-1 rounded-lg border border-hairline/60 bg-void/50 p-3.5">
                ...
                <span className="font-display font-medium text-data">
                  8.5 CGPA
                </span>
              </div>
            ...
            >
              <span>
                {expandedCard === 2
                  ? "[-] HIDE CORE COURSEWORK"
                  : "[+] VIEW CORE COURSEWORK"}
              </span>
            ...
            {expandedCard === 2 && (
              <div className="flex flex-wrap gap-2 pt-2 font-mono text-xs">
                {[
                  ...
                  <span
                    key={idx}
                    className="rounded-md border border-hairline bg-void/80 px-3 py-1.5 text-foam"
                  >
                    {course}
                  </span>
                ))}
          ...
          >
            <div className="flex items-center justify-between font-mono text-xs">
              <span className="text-training font-semibold">
                03 // VERIFIED_WEIGHTS
              </span>
              <span className="text-mist/70">
                FORMAT: CERTIFIED_CREDENTIALS
              </span>
            </div>
            ...
            <div className="grid gap-3 sm:grid-cols-3 font-mono text-sm">
              <div className="flex items-start gap-3 rounded-lg border border-hairline/60 bg-void/50 p-3.5">
                <span className="font-mono text-xs font-bold text-training border border-training/30 rounded px-1.5 py-0.5 bg-training/10">
                  [SIH]
                </span>
                <div className="flex flex-col">
                  ...
                  <span className="text-xs text-mist">
                    National AI / Software Hackathon Winner
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 rounded-lg border border-hairline/60 bg-void/50 p-3.5">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-xs text-mist">
                    Certified Cloud AI Practitioner
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="mt-2 flex items-center justify-between rounded-lg border border-signal/40 bg-signal/10 px-6 py-4 font-mono text-xs text-signal backdrop-blur-md">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold tracking-wider">
              DATA INGESTED ✓ — NEURAL GRAPH SYNCHRONIZED
            </span>
          </div>
          <span className="hidden sm:inline text-mist">
